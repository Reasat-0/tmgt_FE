...
import AuthLayout from "../lib/components/tmgt/features/auth/authLayout";
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="relative">
          ...
          <button
            ...
            className="absolute right-[14px] top-1/2 -translate-y-1/2 text-textDisabled hover:text-textTertiary transition-colors"
          >
